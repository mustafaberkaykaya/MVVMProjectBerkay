...
public enum Asset {
  ...
  public enum Icons {
    ...
    public static let icArrow = ImageAsset(name: "ic_arrow")
    public static let icBackArrow = ImageAsset(name: "ic_back_arrow")
    public static let icCheck = ImageAsset(name: "ic_check")
    public static let icCross = ImageAsset(name: "ic_cross")
    public static let icEdit = ImageAsset(name: "ic_edit")
    public static let icHamburger = ImageAsset(name: "ic_hamburger")
